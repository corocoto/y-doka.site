...
Строчные элементы располагаются друг за другом, как слова в предложении. Если строка начинается слева (как, например, в русском языке), то элементы располагаются слева направо. Если строка начинается справа (как, например, в иврите), то элементы идут справа налево. Ширина и высота строчного элемента равна ширине и высоте содержимого. В отличие от блочного элемента, мы не можем управлять шириной и высотой строчного элемента через CSS. Несколько строчных элементов будут стремиться находиться на одной строке, пока их все можно уместить в ширину родителя. Если ширины родителя не хватает, то лишний текст строчного элемента переносится на следующую строку.
